    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: '#e6f9ee' }]}>
            <Ionicons name="checkmark-circle" size={22} color="#2ecc71" />
            <Text style={styles.statNumber}>{foundCount}</Text>
            <Text style={styles.statLabel}>Found</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: '#f4f3ff' }]}>
            <Ionicons name="people" size={22} color={PURPLE} />
            <Text style={styles.statNumber}>{recentItems.length}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsRow}>
            ...
            >
              <View style={[styles.actionIcon, { backgroundColor: '#f4f3ff' }]}>
                <Ionicons name="add-circle" size={26} color={PURPLE} />
              </View>
              <Text style={styles.actionLabel}>Post Item</Text>
            </TouchableOpacity>
            ...
            >
              <View style={[styles.actionIcon, { backgroundColor: '#e6f9ee' }]}>
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.itemContent}>
                    ...
                    <View style={styles.itemMeta}>
                    <MaterialIcons name="category" size={12} color="black" />
                        <Text style={styles.itemMetaText}>{item.category}</Text>
                      </View>
                    <View style={styles.itemMeta}>
                      <Ionicons name="time-outline" size={12} color="#aaa" />
                      <Text style={styles.itemMetaText}>{item.date_lost_found}</Text>
                    </View>
...
const styles = StyleSheet.create({
  ...
  itemImage: { width: 90, height: 90,  backgroundColor: '#f0f0f0', },
  ...
  itemTitle: { fontSize: 14, fontWeight: '700', color: '#111', flex: 1, marginRight: 6 },
  ...
  itemMetaText: { fontSize: 11, color: '#aaa', flex: 1 },
  itemDesc: { fontSize: 12,lineHeight:20, color: '#888', marginTop: 3 },
